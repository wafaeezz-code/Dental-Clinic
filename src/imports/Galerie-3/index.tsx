import svgPaths from "./svg-atp31kkay6";
import imgImage31 from "./79e10df032f05c8aab740313b3228d891dfbef20.png";
...
import { imgGroup } from "./svg-dsrd5";

function Frame12() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[30px] top-[691px] w-[1380px]">
      <div className="h-[293px] relative shrink-0 w-[440px]" data-name="image-3 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage31} />
      </div>
      <div className="h-[293px] relative shrink-0 w-[440px]" data-name="image-3 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage31} />
      </div>
      <div className="h-[293px] relative shrink-0 w-[440px]" data-name="image-3 3">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage31} />
      </div>
    </div>
  );
...
function Frame13() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[30px] top-[1014px] w-[1380px]">
      <div className="h-[293px] relative shrink-0 w-[440px]" data-name="image-3 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage31} />
      </div>
      <div className="h-[293px] relative shrink-0 w-[440px]" data-name="image-3 2">
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[30px] top-[1337px] w-[1380px]">
      <div className="h-[293px] relative shrink-0 w-[440px]" data-name="image-3 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage31} />
      </div>
      <div className="h-[293px] relative shrink-0 w-[440px]" data-name="image-3 2">
  ...
  return (
    <div className="content-center flex flex-wrap gap-0 items-center relative shrink-0" data-name="Container">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Manrope:ExtraLight',sans-serif] font-extralight justify-center leading-[0] relative shrink-0 text-[#657e7e] text-[15px] whitespace-nowrap">
        <p className="leading-[19.5px] whitespace-pre">{`Galerie   `}</p>
      </div>
    </div>
  );
}
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-center flex flex-wrap gap-0 items-center pb-[137.61px] pt-[117.59px] px-[20px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#173435] text-[54px] tracking-[-1px] whitespace-nowrap">
            <p className="leading-[64.8px]">Galerie</p>
          </div>
          <BackgroundBorder />
        </div>
      </div>
...
function Background() {
  return (
    <div className="absolute content-start flex flex-wrap inset-[240px_30px_1760px_30px] items-start justify-center rounded-[15px]" data-name="Background">
...
function Frame16() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[120px] items-center justify-center left-0 pb-[24px] pt-[80px] px-[80px] top-[1762px] w-[1440px]">
      <Frame11 />
      <Frame5 />
    </div>
  );
...
export default function Galerie() {
  return (
    <div className="bg-white relative size-full" data-name="Galerie">
      <Frame12 />
      <Frame13 />
      <Frame14 />
      <Frame15 />
