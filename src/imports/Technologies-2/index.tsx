import svgPaths from "./svg-69f73z62xx";
import imgAgadirBayDentalClinicLogo1 from "./049e18c660c202068054f76dac750df540371106.png";
import imgDepartment11Jpg from "./13fcd1d366638a51e5541c23296811fa1f20d0c9.png";
...
import { imgGroup } from "./svg-j64yw";

function Container() {
  return <div className="flex-[1_0_0] h-px min-w-px relative" data-name="Container" />;
}

function Section() {
  return (
    <div className="absolute content-stretch flex items-start justify-center left-0 right-0 top-[1034.53px]" data-name="Section">
      <Container />
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="col-1 content-stretch flex gap-px items-center ml-0 mt-0 relative row-1">
      <LinkMenuItem />
      <Frame19 />
    </div>
  );
...
function Department11Jpg() {
  return (
    <div className="h-[319.69px] max-w-[620px] relative rounded-tl-[15px] rounded-tr-[15px] shrink-0 w-[620px]" data-name="department-1-1.jpg">
...
function Container13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-wrap items-start justify-center min-w-px relative self-stretch" data-name="Container">
      <Container14 />
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
      <div className="[word-break:break-word] flex flex-col font-['Manrope:ExtraLight',sans-serif] font-extralight justify-center leading-[0] relative shrink-0 text-[#173435] text-[40px] whitespace-nowrap">
        <p className="leading-[52px]">Laser dentaire</p>
      </div>
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#657e7e] text-[18px] w-[min-content]">
        <p className="leading-[31.5px]">Le laser dentaire permet de réaliser certains soins avec plus de précision, tout en réduisant la douleur et en favorisant une cicatrisation rapide.</p>
      </div>
      <Frame4 />
    </div>
  );
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
      <div className="[word-break:break-word] flex flex-col font-['Manrope:ExtraLight',sans-serif] font-extralight justify-center leading-[0] relative shrink-0 text-[#173435] text-[40px] whitespace-nowrap">
        <p className="leading-[52px]">Radiologie numérique​ 3D</p>
      </div>
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#657e7e] text-[18px] w-[min-content]">
        <p className="leading-[31.5px]">La radiologie numérique offre des images de haute précision avec une exposition réduite aux rayons, permettant un diagnostic fiable et rapide.</p>
      </div>
      <Frame5 />
    </div>
  );
...
function Frame30() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
      <div className="[word-break:break-word] flex flex-col font-['Manrope:ExtraLight',sans-serif] font-extralight justify-center leading-[0] relative shrink-0 text-[#173435] text-[40px] whitespace-nowrap">
        <p className="leading-[52px]">Empreinte Optique SIRONA​</p>
      </div>
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#657e7e] text-[18px] w-[min-content]">
        <p className="leading-[31.5px]">L’empreinte optique remplace les méthodes traditionnelles grâce à une prise d’empreinte numérique rapide, précise et plus confortable pour le patient.</p>
      </div>
      <Frame8 />
    </div>
  );
...
function Frame31() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
      <div className="[word-break:break-word] flex flex-col font-['Manrope:ExtraLight',sans-serif] font-extralight justify-center leading-[0] relative shrink-0 text-[#173435] text-[40px] whitespace-nowrap">
        <p className="leading-[52px]">Impression 3D dentaire​</p>
      </div>
      <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#657e7e] text-[18px] w-[min-content]">
        <p className="leading-[31.5px]">L’impression 3D permet de concevoir des dispositifs dentaires sur mesure avec une grande précision, pour des traitements plus rapides et efficaces.</p>
      </div>
      <Frame12 />
    </div>
  );
...
function Frame34() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[80px] items-start left-[3px] px-[80px] top-[652px] w-[1440px]">
      <Frame32 />
      <Frame33 />
    </div>
  );
...
function Frame36() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[120px] items-center justify-center left-[3px] pb-[24px] pt-[80px] px-[80px] top-[2177px] w-[1440px]">
      <Frame27 />
      <Frame21 />
    </div>
  );
  ...
  return (
    <div className="content-center flex flex-wrap gap-0 items-center relative shrink-0" data-name="Container">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Manrope:ExtraLight',sans-serif] font-extralight justify-center leading-[0] relative shrink-0 text-[#657e7e] text-[15px] whitespace-nowrap">
        <p className="leading-[19.5px] whitespace-pre">{`Technologies   `}</p>
      </div>
    </div>
  );
}
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-center flex flex-wrap gap-0 items-center pb-[137.61px] pt-[117.59px] px-[20px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#173435] text-[54px] tracking-[-1px] whitespace-nowrap">
            <p className="leading-[64.8px]">Technologies</p>
          </div>
          <BackgroundBorder />
        </div>
      </div>
...
function Background() {
  return (
    <div className="absolute content-start flex flex-wrap inset-[195px_36px_2220px_24px] items-start justify-center rounded-[15px]" data-name="Background">
...
export default function Technologies() {
  return (
    <div className="bg-white relative size-full" data-name="Technologies">
      <Section />
      <Frame35 />
      <Frame34 />
      <Frame36 />
